...
namespace {
struct qt_meta_tag_ZN11USERACCOUNTE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11USERACCOUNTE = QtMocHelpers::stringData(
    "USERACCOUNT",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11USERACCOUNTE[] = {
...
Q_CONSTINIT const QMetaObject USERACCOUNT::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11USERACCOUNTE.offsetsAndSizes,
    qt_meta_data_ZN11USERACCOUNTE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11USERACCOUNTE_t,
        // Q_OBJECT / Q_GADGET
...
void *USERACCOUNT::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11USERACCOUNTE.stringdata0))
